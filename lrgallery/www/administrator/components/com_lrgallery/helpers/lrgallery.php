<?php
    ...
    abstract class LrgalleryHelper
    {
        ...
        {
            JSubMenuHelper::addEntry('Фотографии', 'index.php?option=com_lrgallery', 
                    $submenu == 'photos');
            JSubMenuHelper::addEntry('Папки пользователей', 'index.php?option=com_lrgallery&view=userfolders', 
                    $submenu == 'userfolders');
            JSubMenuHelper::addEntry('Поля метаданных', 'index.php?option=com_lrgallery&view=metas', 
                    $submenu == 'metas');
            JSubMenuHelper::addEntry('Метаданные', 'index.php?option=com_lrgallery&view=metadatas', 
                    $submenu == 'metadatas');
