...
LrGalleryPublishServiceProvider.lua
Publish-specific portions of Lightroom LrGallery uploader
...
-- publishServiceProvider.titleForPublishedCollectionSet = "(something)" -- not used for LrGallery plug-in
...
--publishServiceProvider.titleForPublishedCollectionSet_standalone = "(something)" -- not used for LrGallery plug-in
...
publishServiceProvider.titleForGoToPublishedPhoto = LOC "$$$/LrGallery/TitleForGoToPublishedCollection=Show in LrGallery"
...
--[[ Not used for LrGallery plug-in. This is an example of how this function might work.
...
function publishServiceProvider.imposeSortOrderOnPublishedCollection( publishSettings, info, remoteIdSequence )
	...
	if photosetId then
		...
		local existingPhotoSequence = LrGalleryAPI.listPhotosFromPhotoset( publishSettings, { photosetId = photosetId } )
		...
		LrGalleryAPI.setPhotosetSequence( publishSettings, {
...
-- publishServiceProvider.disableRenamePublishedCollection = true -- not used for LrGallery sample plug-in
...
-- publishServiceProvider.disableRenamePublishedCollectionSet = true -- not used for LrGallery sample plug-in
...
publishServiceProvider.titleForPhotoRating = LOC "$$$/LrGallery/TitleForPhotoRating=Favorite Count"
